        ...
        <div class="mp-card">
            <div class="mp-sec-title" style="display:flex; justify-content:space-between; align-items:center;">
                ...
                <div style="display:flex; gap:6px;">
                    ...
                    <button id="sort-oldest" onclick="loadLikedSupplements('oldest', this)"
                            style="font-size:11px; padding:4px 12px; border:1px solid #ccc;
                ...
                <c:choose>
                    <c:when test="${not empty likedSupplements}">
                        <c:forEach var="supp" items="${likedSupplements}">
                            <div class="like-card" style="border:1px solid #eee; border-radius:10px;
                             ...
                             display:flex; flex-direction:column; justify-content:space-between;">
                                     ...
                                     overflow:hidden; background:#f8f9fa; margin-bottom:12px;">
                                        <c:choose>
                                            <c:when test="${fn:startsWith(supp.supplementImagePath, 'http')}">
                                                <img src="${supp.supplementImagePath}"
                                ...
                                <button onclick="showSupplementDetail('${supp.supplementId}',
                                        '${supp.supplementName}','${supp.supplementEfficacy}',
                                        '${supp.supplementDosage}','${supp.supplementTiming}',
                                        '${supp.supplementCaution}','${supp.supplementImagePath}')"
