...
(
    ...
    product_start_date  DATE,                        -- '복용 시작일'
...
-- 7. 단백질 보충제 (근력 운동)
INSERT INTO products (product_id, product_admin, product_name, product_brand, product_price, product_nutrient, product_description, product_image, product_total, product_serve, product_per_day, product_time_info, product_start_date, product_current)
VALUES (107, 'admin_kyy', '마이프로틴 웨이 프로틴', '마이프로틴', 45000, 7, '고품질 유청 단백질 분말', '/images/whey.jpg', 40, 1, 2, '운동 직후 또는 식간에 섭취', TO_DATE('2026-03-20', 'YYYY-MM-DD'), 30);

-- 8. 마그네슘 (신경 및 근육 건강)
INSERT INTO products (product_id, product_admin, product_name, product_brand, product_price, product_nutrient, product_description, product_image, product_total, product_serve, product_per_day, product_time_info, product_start_date, product_current)
VALUES (108, 'admin_kyy', '킬레이트 마그네슘 200mg', '블루보넷', 38000, 8, '흡수율이 높은 킬레이트 형태', '/images/magnesium.jpg', 120, 2, 1, '취침 1시간 전 복용 권장', TO_DATE('2026-03-25', 'YYYY-MM-DD'), 110);

-- 9. 코엔자임 Q10 (항산화)
INSERT INTO products (product_id, product_admin, product_name, product_brand, product_price, product_nutrient, product_description, product_image, product_total, product_serve, product_per_day, product_time_info, product_start_date, product_current)
VALUES (109, 'admin_kyy', '코큐텐 항산화 플러스', '세노비스', 22000, 9, '높은 혈압 감소 및 항산화 도움', '/images/coq10.jpg', 60, 1, 1, '점심 식사 직후 복용', TO_DATE('2026-04-02', 'YYYY-MM-DD'), 58);

-- 10. 비타민 D (뼈 건강)
INSERT INTO products (product_id, product_admin, product_name, product_brand, product_price, product_nutrient, product_description, product_image, product_total, product_serve, product_per_day, product_time_info, product_start_date, product_current)
VALUES (110, 'admin_kyy', '액상 비타민D3 2000IU', '닥터라인', 19000, 10, '흡수가 빠른 액상 타입 비타민D', '/images/vitamind.jpg', 30, 1, 1, '식사 중 혹은 식후 즉시', TO_DATE('2026-03-28', 'YYYY-MM-DD'), 25);
