...
<div class="curation-layout">
    ...
    <div class="curation-sidebar">
        ...
        <button class="curation-cat-btn" onclick="selectCategory(this, '임산부')">임산부</button>
        <button class="curation-cat-btn" onclick="selectCategory(this, '수험생')">수험생</button>
        <button class="curation-cat-btn" onclick="selectCategory(this, '직장인')">직장인</button>
        <button class="curation-cat-btn" onclick="selectCategory(this, '운동하는 사람')">운동하는 사람</button>
        <button class="curation-cat-btn" onclick="selectCategory(this, '다이어트')">다이어트</button>
        <button class="curation-cat-btn" onclick="selectCategory(this, '비건')">비건</button>
        <button class="curation-cat-btn" onclick="selectCategory(this, '노년층')">노년층</button>
    </div>
...
<script>
    ...
    function selectCategory(btn, category) {
        ...
        document.getElementById('curationTitle').textContent = category + ' 맞춤 영양소 추천';
        document.getElementById('curationSubtitle').textContent = 'AI 오터가 분석한 ' + category + ' 맞춤 영양제 큐레이션';
    ...
    function fetchCuration(category) {
        ...
        fetch('http://10.1.82.100/api', {   // ← 실제 엔드포인트로 수정
            method: 'POST',
