...
-- 9. 비타민 C
INSERT INTO supplements (supplement_id, supplement_name, supplement_efficacy, supplement_dosage, supplement_timing, supplement_caution, supplement_image_path)
VALUES (seq_supplements_id.NEXTVAL, '비타민 C', '3대 영양소 대사의 조효소로 작용하며 소변을 노란색으로 변하게 함. 시각·점막·피부·손발톱 등의 세포 성장과 유지에 필수적임.', '약 1.3mg', '식전', '수용성으로 식전 복용이 흡수에 유리하나, 고함량 복용 시 속 쓰림이 있다면 식후 30분에 복용함. 신진대사 증진으로 수면을 방해할 수 있어 이른 시간에 섭취하는 것이 좋음.', 'https://weekly.chosun.com/news/photo/202305/26499_49726_360.gif');
